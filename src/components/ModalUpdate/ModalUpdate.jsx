          ...
          >
            <div className="bg-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
              <div className="sm:flex sm:items-start">
                <div className="mx-auto flex size-12 shrink-0 items-center justify-center rounded-md bg-green-100 sm:mx-0 sm:size-10">
                  <PlusCircle size={32} weight="bold" color="green" />
                </div>
